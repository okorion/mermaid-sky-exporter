...
export default function ExportButtons({
  ...
  return (
    ...
    >
      <div className="rounded-xl border border-slate-200/80 bg-white/70 px-2 py-2 shadow-sm backdrop-blur">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <input
            ...
            className="h-9 min-w-0 w-full rounded-lg border border-slate-200 px-2 text-sm outline-none focus:ring-2 focus:ring-slate-300 sm:max-w-[180px]"
            placeholder="diagram"
            spellCheck={false}
          />
          ...
          <div className="grid grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto] gap-2 sm:flex sm:items-center">
            ...
            <button
              ...
              className={[
                "h-9 whitespace-nowrap rounded-lg px-4 text-sm font-semibold text-white shadow-sm transition",
                hasExportableDiagram
      ...
      <p
        className="mt-1 text-[11px] leading-tight text-slate-500 sm:whitespace-nowrap"
        aria-live="polite"
      >
        {hint}
      </p>
